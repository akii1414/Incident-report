    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <x-text-input id="middle_name" name="middle_name" type="text" class="mt-1 block w-full" :value="old('middle_name', optional($user->profile)->middle_name)" required autofocus autocomplete="middle_name" />
